...
if(isset($_POST['add_product'])){
   ...
   if($insert_query){
      ...
      $message[] = 'produk berhasil ditabahkan';
   }else{
...
if(isset($_POST['update_product'])){
   ...
   $p_description = $_POST['update_p_description'];
...
<section class="edit-form-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <textarea class="text" required name="update_p_description"><?php echo $fetch_edit['description']; ?></textarea>
