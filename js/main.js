...
$(function () {
  ...
  $('#myDiv').venomButton({
    phone: '+62 857 2233 1911',
    message: 'Hi! Apakah produknya masih ada...?',
    chatMessage: 'Hallo kak 👋<br>Cuma mau ingetin, Jika ada kendala, boleh langsung balas chat ini ya kak. Happy shopping & have a nice day!<br>',
    avatar: '../images/logo.png',
    showPopup: true,
    position: 'right',
    linkButton: false,
    showOnIE: false,
    nameClient: 'Fvvki Clothing',
    headerTitle: 'Admin',
  });
